module.exports = {
  ...
  sendFrom: 'sendfrom',
  sendMany: 'sendmany',
  sendRawTransaction: 'sendrawtransaction', // litecoind <= v0.17
  sendRawTransactionWithKey: 'signrawtransactionwithkey', // litecoind >= v0.17
  sendRawTransactionWithWallet: 'signrawtransactionwithwallet', // litecoind >= v0.17
